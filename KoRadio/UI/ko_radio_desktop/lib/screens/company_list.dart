      ...
      child: Column(
        ...
        children: [
         ...
         width: double.infinity,
           ...
           child:  Row(
             children: [
               const Expanded(flex: 5, child: Text("Ime", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white))),
               const Expanded(flex: 4, child: Text("Email", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white))),
               ...
               const Expanded(flex: 2, child: Text("Rating", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white))),
               const Expanded(flex: 2, child: Text("Broj Zaposlenika", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white))),
              const Expanded(
             flex: 3,
             child: Center(
               child: Text(
               ...
               const Expanded(flex: 3, child: Text("Usluge", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white))),
                showApplicants ? const Expanded(flex: 1, child: Center(child: Text("Obrtni list", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)))) : const SizedBox(width: 0),
