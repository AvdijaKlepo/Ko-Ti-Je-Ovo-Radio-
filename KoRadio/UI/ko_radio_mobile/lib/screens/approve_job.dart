      ...
      floatingActionButton: Row(
        ...
        children: [
          ...
          ElevatedButton(onPressed: (){
            ...
            ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Posao odbijen.')));
          ...
          const SizedBox(width: 15,),
            ...
            ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Faktura poslana korisniku.')));
                ...
                if (widget.job.jobStatus == JobStatus.approved)
                  Column(
                    ...
                    children: [
                      ...
                      _buildInfoRow('Procjena cijene:',
                          widget.job.payEstimate?.toString() ?? '-'),
                      FormBuilderTextField(
                        name: "payInvoice",
