...
namespace KoRadio.Services.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Company",
                columns: new[] { "CompanyID", "Bio", "CompanyName", "Email", "EndTime", "ExperianceYears", "Image", "IsApplicant", "IsDeleted", "LocationID", "PhoneNumber", "Rating", "RatingSum", "StartTime", "TotalRatings", "WorkingDays" },
                values: new object[,]
                {
                    { 1, "Firma koja se bavi elektroinstalacijama i održavanjem električnih sistema.", "Elektroinženjering d.o.o.", "elektro@email.com", new TimeOnly(16, 0, 0), 5, null, false, false, 1, "+38761223226", 4.00m, 72.00m, new TimeOnly(8, 0, 0), 17, 54 },
                    { 2, "Firma koja se bavi elektroinstalacijama i održavanjem električnih sistema te keramikom.", "Elektroinženjering i Keramika d.o.o.", "elektroKeramika@email.com", new TimeOnly(16, 0, 0), 3, null, false, false, 1, "+38761223312", 3.00m, 72.00m, new TimeOnly(8, 0, 0), 17, 54 },
                    { 3, "Firma koja se bavi zidarstvom i molerajom.", "Zidarstvo i Moleraj d.o.o.", "zidarmoler@email.com", new TimeOnly(16, 0, 0), 7, null, false, false, 1, "+38761223317", 3.00m, 72.00m, new TimeOnly(8, 0, 0), 17, 54 },
                    { 4, "Firma koja se bavi molerajom i higijenom.", "Moleraj i Higijena d.o.o.", "higijenamoler@email.com", new TimeOnly(16, 0, 0), 7, null, false, false, 2, "+38761223327", 3.00m, 72.00m, new TimeOnly(8, 0, 0), 17, 54 },
                    { 5, "Firma koja se bavi umrežavanjem", "Umreži", "umreži@email.com", new TimeOnly(16, 0, 0), 7, null, false, false, 2, "+38761423327", 3.00m, 72.00m, new TimeOnly(8, 0, 0), 17, 54 },
                    { 6, "Firma koja se bavi staklarstvom", "Staklo Mostar", "staklo@email.com", new TimeOnly(16, 0, 0), 7, null, false, false, 1, "+38761433327", 3.00m, 72.00m, new TimeOnly(8, 0, 0), 17, 54 },
                    { 7, "Firma koja se bavi zidarstvom", "Zidarstvo Sarajevo", "zidari@email.com", new TimeOnly(16, 0, 0), 7, null, false, false, 2, "+38761434327", 3.00m, 72.00m, new TimeOnly(8, 0, 0), 17, 54 }
                });
            ...
            migrationBuilder.InsertData(
                table: "Freelancer",
                columns: new[] { "FreelancerID", "Bio", "EndTime", "ExperianceYears", "IsApplicant", "IsDeleted", "Rating", "RatingSum", "StartTime", "TotalRatings", "WorkingDays" },
                values: new object[,]
                {
                    { 4, "Iskusan električar sa 6 godina iskustva. Završen zanat u elektrotehničkoj školi u Mostaru.", new TimeOnly(16, 0, 0), 6, false, false, 3.63m, 0.0, new TimeOnly(8, 0, 0), 0, 54 },
                    { 9, "Iskusan keramičar sa 4 godina iskustva. Završen zanat u Mostaru.", new TimeOnly(16, 0, 0), 4, false, false, 4.00m, 0.0, new TimeOnly(8, 0, 0), 0, 54 },
                    { 10, "Iskusan moler sa 9 godina iskustva. Završen zanat u Mostaru.", new TimeOnly(16, 0, 0), 9, false, false, 4.00m, 0.0, new TimeOnly(8, 0, 0), 0, 54 },
                    { 11, "Iskusan zidar sa 5 godina iskustva. Završen zanat u Mostaru.", new TimeOnly(16, 0, 0), 5, false, false, 4.00m, 0.0, new TimeOnly(8, 0, 0), 0, 54 },
                    { 12, "Iskusan staklar sa 7 godina iskustva. Završen zanat u Mostaru.", new TimeOnly(16, 0, 0), 7, false, false, 4.00m, 0.0, new TimeOnly(8, 0, 0), 0, 54 },
                    { 13, "Iskusan radnik za higijenu sa 3 godine iskustva. Završen zanat u Mostaru.", new TimeOnly(16, 0, 0), 3, false, false, 4.00m, 0.0, new TimeOnly(8, 0, 0), 0, 54 },
                    { 14, "Iskusan radnik za mreže sa 4 godine iskustva. Završen zanat u Mostaru.", new TimeOnly(16, 0, 0), 4, false, false, 4.00m, 0.0, new TimeOnly(8, 0, 0), 0, 54 }
                });

            migrationBuilder.InsertData(
                table: "Jobs",
                columns: new[] { "JobId", "CompanyID", "DateFinished", "EndEstimate", "FreelancerID", "Image", "IsApproved", "IsDeleted", "IsDeletedWorker", "IsEdited", "isFreelancer", "IsInvoiced", "IsRated", "isTenderFinalized", "IsWorkerEdited", "JobDate", "JobDescription", "Job_Status", "JobTitle", "PayEstimate", "PayInvoice", "RescheduleNote", "StartEstimate", "UserID" },
                values: new object[,]
                {
                    { 10, 1, new DateTime(2025, 8, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, null, false, false, false, false, false, true, true, false, false, new DateTime(2025, 5, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "Potrebna popravka elektroinstalacija u stanu, uključujući zamjenu prekidača i utičnica.", "finished", "Popravka elektroinstalacija", null, null, null, null, 2 },
                    { 11, 2, new DateTime(2025, 8, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, null, false, false, false, false, false, true, true, false, false, new DateTime(2025, 5, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "Potrebna popravka elektroinstalacija u stanu, uključujući zamjenu prekidača i utičnica.", "finished", "Popravka elektroinstalacija", null, null, null, null, 2 },
                    { 12, 4, new DateTime(2025, 8, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, null, false, false, false, false, false, true, true, false, false, new DateTime(2025, 5, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "Potrebna popravka elektroinstalacija u stanu, uključujući zamjenu prekidača i utičnica.", "finished", "Popravka elektroinstalacija", null, null, null, null, 2 },
                    { 13, 1, new DateTime(2025, 8, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, null, false, false, false, false, false, true, true, false, false, new DateTime(2025, 5, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "Potrebna popravka elektroinstalacija u stanu, uključujući zamjenu prekidača i utičnica.", "finished", "Popravka elektroinstalacija", null, null, null, null, 3 },
                    { 14, 5, new DateTime(2025, 8, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, null, false, false, false, false, false, true, true, false, false, new DateTime(2025, 5, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "Potrebna popravka elektroinstalacija u stanu, uključujući zamjenu prekidača i utičnica.", "finished", "Popravka elektroinstalacija", null, null, null, null, 3 },
                    { 15, 7, new DateTime(2025, 8, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, null, false, false, false, false, false, true, true, false, false, new DateTime(2025, 5, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "Potrebna popravka elektroinstalacija u stanu, uključujući zamjenu prekidača i utičnica.", "finished", "Popravka elektroinstalacija", null, null, null, null, 3 },
                    { 16, 1, new DateTime(2025, 8, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, null, false, false, false, false, false, true, true, false, false, new DateTime(2025, 5, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "Potrebna popravka elektroinstalacija u stanu, uključujući zamjenu prekidača i utičnica.", "finished", "Popravka elektroinstalacija", null, null, null, null, 21 },
                    { 17, 2, new DateTime(2025, 8, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, null, false, false, false, false, false, true, true, false, false, new DateTime(2025, 5, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "Potrebna popravka elektroinstalacija u stanu, uključujući zamjenu prekidača i utičnica.", "finished", "Popravka elektroinstalacija", null, null, null, null, 21 },
                    { 18, 4, new DateTime(2025, 8, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, null, false, false, false, false, false, true, true, false, false, new DateTime(2025, 5, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "Potrebna popravka elektroinstalacija u stanu, uključujući zamjenu prekidača i utičnica.", "finished", "Popravka elektroinstalacija", null, null, null, null, 21 }
                });

            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "OrderId", "CreatedAt", "IsCancelled", "IsShipped", "OrderNumber", "UserId" },
                values: new object[,]
                {
                    { 1, new DateTime(2025, 5, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), false, false, 20124, 2 },
                    { 2, new DateTime(2025, 5, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), false, false, 20125, 3 },
                    { 3, new DateTime(2025, 5, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), false, false, 20126, 2 },
                    { 4, new DateTime(2025, 5, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), false, false, 20127, 3 }
                });

            migrationBuilder.InsertData(
                table: "Stores",
                columns: new[] { "StoreId", "Address", "Description", "Image", "IsApplicant", "IsDeleted", "LocationId", "StoreName", "UserId" },
                values: new object[,]
                {
                    { 1, "Mostar, b.b.", "Prodaja elektro materijala i alata.", null, false, false, 1, "Elektro Materijal", 7 },
                    { 2, "Mostar, b.b.", "Prodaja keramike", null, false, false, 1, "Keramik Stop", 8 },
                    { 3, "Sarajevo, b.b.", "Prodaja građevinskog materijala i alata.", null, false, false, 2, "Građevinski Materijal", 3 },
                    { 4, "Sarajevo, b.b.", "Prodaja boja i lakova za molerske radove.", null, false, false, 2, "Moleraj Plus", 3 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, null, new TimeOnly(18, 0, 0), 4, null, false, false, false, false, false, true, true, false, false, new DateTime(2025, 5, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "Potrebna popravka elektroinstalacija u stanu, uključujući zamjenu prekidača i utičnica.", "finished", "Popravka elektroinstalacija", null, null, null, new TimeOnly(10, 0, 0), 2 },
                    { 2, null, null, new TimeOnly(18, 0, 0), 9, null, false, false, false, false, false, true, true, false, false, new DateTime(2025, 5, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "Potrebno postavljanje keramike na balkonu", "finished", "Postavljanje keramike", null, null, null, new TimeOnly(10, 0, 0), 2 },
                    { 3, null, null, new TimeOnly(18, 0, 0), 10, null, false, false, false, false, false, true, true, false, false, new DateTime(2025, 5, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "Potrebna popravka elektroinstalacija u stanu, uključujući zamjenu prekidača i utičnica.", "finished", "Popravka elektroinstalacija", null, null, null, new TimeOnly(10, 0, 0), 2 },
                    { 4, null, new DateTime(2025, 8, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 4, null, false, false, false, false, false, true, true, false, false, new DateTime(2025, 5, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "Potrebno postavljanje keramike na balkonu", "finished", "Postavljanje keramike", null, null, null, null, 3 },
                    { 5, null, null, new TimeOnly(18, 0, 0), 11, null, false, false, false, false, false, true, true, false, false, new DateTime(2025, 5, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "Potrebna popravka elektroinstalacija u stanu, uključujući zamjenu prekidača i utičnica.", "finished", "Popravka elektroinstalacija", null, null, null, new TimeOnly(10, 0, 0), 3 },
                    { 6, null, new DateTime(2025, 8, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 12, null, false, false, false, false, false, true, true, false, false, new DateTime(2025, 5, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "Potrebno postavljanje keramike na balkonu", "finished", "Postavljanje keramike", null, null, null, null, 3 },
                    { 7, null, null, new TimeOnly(17, 0, 0), 9, null, false, false, false, false, false, true, true, false, false, new DateTime(2025, 5, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "Potrebno krečenje i farbanje zidova u kući, uključujući pripremu površina i završne radove.", "finished", "Molerski radovi u kući", null, null, null, new TimeOnly(9, 0, 0), 21 },
                    { 8, null, null, new TimeOnly(16, 0, 0), 11, null, false, false, false, false, false, true, true, false, false, new DateTime(2025, 5, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "Potrebna hitna popravka krova zbog curenja vode, uključujući zamjenu oštećenih delova i hidroizolaciju.", "finished", "Popravka krova", null, null, null, new TimeOnly(8, 0, 0), 21 },
                    { 9, null, null, new TimeOnly(15, 0, 0), 13, null, false, false, false, false, false, true, true, false, false, new DateTime(2025, 5, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "Potrebna instalacija solarnih panela na krovu kuće, uključujući montažu i povezivanje sa električnim sistemom.", "finished", "Instalacija solarnih panela", null, null, null, new TimeOnly(7, 0, 0), 21 }
                });
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "Image", "IsDeleted", "Price", "ProductDescription", "ProductName", "StoreId" },
                values: new object[,]
                {
                    { 1, null, false, 25.00m, " Produžni kabl dužine 5 metara, idealan za kućnu i kancelarijsku upotrebu.", "Produžni kabl 5m", 1 },
                    { 2, null, false, 45.00m, "Visokokvalitetni Ethernet kabal dužine 20 metara za pouzdanu mrežnu povezanost.", "Ethernet kabal 20m", 1 },
                    { 3, null, false, 15.00m, "Standardni prekidač naizmenične struje za kućnu i industrijsku upotrebu.", "Prekidač naizmenične struje", 1 },
                    { 4, null, false, 10.00m, "Energetski efikasna LED žarulja snage 9W, pruža jarko svetlo uz nisku potrošnju energije.", "LED žarulja 9W", 1 },
                    { 5, null, false, 20.00m, "Visokokvalitetna ravna keramika dimenzija 30x30cm, idealna za podove i zidove.", "Ravna keramika 30x30cm", 2 },
                    { 6, null, false, 15.00m, "Izdržljive keramičke pločice dimenzija 20x20cm, pogodne za različite površine.", "Keramičke pločice 20x20cm", 2 },
                    { 7, null, false, 30.00m, "Kvalitetna fug masa u pakovanju od 5kg, idealna za popunjavanje spojeva između pločica.", "Fug masa 5kg", 2 },
                    { 8, null, false, 50.00m, "Snažno ljepilo za keramiku u pakovanju od 10kg, pruža čvrsto prizemljivanje pločica na različite površine.", "Ljepilo za keramiku 10kg", 2 },
                    { 9, null, false, 8.00m, "Visokokvalitetni cement u pakovanju od 25kg, pogodan za različite građevinske radove.", "Cement 25kg", 3 },
                    { 10, null, false, 5.00m, "Fini pijesak u pakovanju od 50kg, idealan za malterisanje i druge građevinske primjene.", "Pijesak 50kg", 3 },
                    { 11, null, false, 12.00m, "Kvalitetan malter u pakovanju od 30kg, pogodan za unutrašnje i vanjske zidove.", "Malter 30kg", 3 },
                    { 12, null, false, 25.00m, "Unutrašnja boja za zidove u pakovanju od 5L, dostupna u različitim bojama.", "Boja za zidove 5L", 4 },
                    { 13, null, false, 15.00m, "Visokokvalitetni lak za drvo u pakovanju od 1L, pruža zaštitu i sjaj drvenim površinama.", "Lak za drvo 1L", 4 },
                    { 14, null, false, 7.00m, "Kvalitetan valjak za boju, idealan za brzo i ravnomerno nanošenje boje na zidove.", "Valjak za boju", 4 },
                    { 15, null, false, 5.00m, "Izdržljiva četka za boju, pogodna za precizno nanošenje boje na različite površine.", "Četka za boju", 4 },
                    { 16, null, false, 40.00m, "Velika kanta za boju u pakovanju od 10L, idealna za veće projekte farbanja.", "Kanta za boju 10L", 4 }
                });
            ...
            migrationBuilder.InsertData(
                table: "OrderItems",
                columns: new[] { "OrderItemsId", "OrderId", "ProductId", "Quantity", "StoreId" },
                values: new object[,]
                {
                    { 1, 1, 1, 2, 1 },
                    { 2, 1, 4, 5, 1 },
