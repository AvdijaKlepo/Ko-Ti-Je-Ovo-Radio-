...
namespace KoRadio.Services.Migrations
{
    ...
    [Migration("20250702113512_storesConflictFix")]
    partial class storesConflictFix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KoRadio.Services.Database.OrderItems", b =>
                {
            ...
            modelBuilder.Entity("KoRadio.Services.Database.Orders", b =>
                {
                    b.Property<int>("OrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KoRadio.Services.Database.Products", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KoRadio.Services.Database.OrderItems", b =>
                {
                    b.HasOne("KoRadio.Services.Database.Orders", "Order")
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KoRadio.Services.Database.Products", "Product")
                        .WithMany("OrderItems")
