  ...
  //      );
        modelBuilder.Entity<Database.Job>().HasData(
            new Database.Job
            {
                ...
                JobDate = new DateTime(2025, 06, 25),
                DateFinished = new DateTime(2025, 06, 26),
		...
		modelBuilder.Entity<Database.UserRating>().HasData(
		   ...
		   new Database.UserRating { UserRatingId = 10, CompanyId = 1, UserId = 2, Rating = 5, JobId = 10 },
		   new Database.UserRating { UserRatingId = 11, CompanyId = 2, UserId = 2, Rating = 4, JobId = 11 },
		   new Database.UserRating { UserRatingId = 12, CompanyId = 4, UserId = 2, Rating = 3, JobId = 12 },


		   new Database.UserRating { UserRatingId = 13, CompanyId = 1, UserId = 3, Rating = 4, JobId = 13 },
		   new Database.UserRating { UserRatingId = 14, CompanyId = 5, UserId = 3, Rating = 5, JobId = 14 },
		   new Database.UserRating { UserRatingId = 15, CompanyId = 7, UserId = 3, Rating = 2, JobId = 15 },


		   new Database.UserRating { UserRatingId = 16, CompanyId = 1, UserId = 21, Rating = 5, JobId = 16 },
		   new Database.UserRating { UserRatingId = 17, CompanyId = 2, UserId = 21, Rating = 4, JobId = 17 },
		   new Database.UserRating { UserRatingId = 18, CompanyId = 4, UserId = 21, Rating = 3, JobId = 18 }
